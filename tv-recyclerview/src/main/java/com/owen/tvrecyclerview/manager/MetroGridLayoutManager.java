package com.owen.tvrecyclerview.manager;
...
public class MetroGridLayoutManager extends GridLayoutManager {
    ...
    private static final String TAG = "MetroGridLayoutManager";
    ...
    public boolean requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect, boolean immediate, boolean focusedChildVisible) {
        ...
        if(mSelectedSectionIndex != lp.sectionIndex) {
            ...
            final boolean supportIntelligentScroll = direction == Direction.END ? lp.isSupportIntelligentScrollEnd : lp.isSupportIntelligentScrollStart;
            if (mIsIntelligentScroll && supportIntelligentScroll && parent instanceof TvRecyclerView) {
        ...
        return result || super.requestChildRectangleOnScreen(parent, child, rect, immediate, focusedChildVisible);
    }
    ...
    public boolean checkLayoutParams(RecyclerView.LayoutParams lp) {
        ...
        if (lp instanceof LayoutParams) {
            ...
            Log.e(TAG, "checkLayoutParams: " + getLaneCount() + " : " + mLaneCounts[metroLp.sectionIndex] + " : " + metroLp.sectionIndex);
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        public boolean isSupportIntelligentScrollStart;
        public boolean isSupportIntelligentScrollEnd;
        ...
        private void init(ViewGroup.LayoutParams other) {
            if (null != other && other instanceof LayoutParams) {
                ...
                this.isSupportIntelligentScrollStart = lp.isSupportIntelligentScrollStart;
                this.isSupportIntelligentScrollEnd = lp.isSupportIntelligentScrollEnd;
            } else {
                ...
                isSupportIntelligentScrollStart = true;
                isSupportIntelligentScrollEnd = true;
            }
        }
