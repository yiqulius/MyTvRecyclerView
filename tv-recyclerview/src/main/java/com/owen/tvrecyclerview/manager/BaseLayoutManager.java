...
//        Log.i(LOGTAG, "onItemsAdded: positionStart="+positionStart+" ,itemCount="+itemCount);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        final LaneSavedState state = new LaneSavedState(superState);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        final LaneSavedState ss = (LaneSavedState) state;
    ...
    public LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        final LayoutParams laneLp = new LayoutParams((MarginLayoutParams) lp);
        if (isVertical()) {
            laneLp.width = LayoutParams.MATCH_PARENT;
            laneLp.height = lp.height;
        } else {
            laneLp.width = lp.width;
            laneLp.height = LayoutParams.MATCH_PARENT;
        }
    ...
    protected static class LaneSavedState extends SavedState {
        private Orientation orientation;
        private Rect[] lanes;
        private float laneSize;
        private ItemEntries itemEntries;

        protected LaneSavedState(Parcelable superState) {
            super(superState);
        }

        private LaneSavedState(Parcel in) {
            super(in);
        ...
        public static final Creator<LaneSavedState> CREATOR
                = new Creator<LaneSavedState>() {
            @Override
            public LaneSavedState createFromParcel(Parcel in) {
                return new LaneSavedState(in);
            }

            @Override
            public LaneSavedState[] newArray(int size) {
                return new LaneSavedState[size];
            }
        };
    }
